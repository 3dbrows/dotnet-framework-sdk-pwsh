...
RUN dotnet tool install --global PowerShell ; `
    ...
    $args = '--quiet --wait --norestart --nocache --installPath C:\BuildTools2019 --add Microsoft.VisualStudio.Workload.ManagedDesktopBuildTools --includeRecommended --includeOptional' ; `
    Start-Process -Wait -FilePath vs_buildtools.exe -ArgumentList "$args" ; `
